...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {		
		...
		Parent root = FXMLLoader.load(getClass().getResource("/GUIandDataVisTeamTestPackage/Map.fxml"));	
		String image = Main.class.getResource("/GUIandDataVisTeamTestPackage/map.png").toExternalForm();
