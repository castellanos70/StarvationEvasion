...
public class CardNode extends NodeTemplate
{
  ...
  public CardNode(int i){
    super();
    cardImage = new Image(getClass().getResource("/starvationevasion/GuiTestCode/resources/card" + i + ".png").toString());
