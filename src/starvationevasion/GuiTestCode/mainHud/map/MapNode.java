package starvationevasion.GuiTestCode.mainHud.map;
...
public class MapNode extends NodeTemplate
{
  ...
  public MapNode(double width, double height){
    super();
    this.setSize(width, height);
    this.width = width;
    this.height = height;
    
    hand = new HandNode(width*(2/3d), height/2);
    hand.setLayoutX(20);
