...
/**
 * ActionButtons are the starvationevasion.client.Aegislash.GUI element which are responsible for allowing the user to tell the server that they're done with drafting,
...
public class ActionButtons extends HBox
{
  ...
  /**
   * Default constructor. Takes a reference to the starvationevasion.client.Aegislash.GUI which owns it
   * @param gui
   */
