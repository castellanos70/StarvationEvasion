...
import starvationevasion.client.Aegislash.GUI.DraftLayout.ProductBar.ProductBar;
import starvationevasion.client.Aegislash.GUI.DraftLayout.hand.Hand;
import starvationevasion.client.Aegislash.GUI.DraftLayout.map.Map;
import starvationevasion.client.Aegislash.GUI.GUI;
import starvationevasion.client.Aegislash.GUI.Popups.DiscardDisplay;
import starvationevasion.client.Aegislash.GUI.SummaryBar;
import starvationevasion.client.Aegislash.GUI.Popups.GraphDisplay;
import starvationevasion.client.Aegislash.GUI.Popups.ProductBarDataDisplay;
...
/**
 * The DraftLayout class is responsible for the layout the starvationevasion.client.Aegislash.GUI displays during the draft phase of the game
 * It holds the starvationevasion.client.Aegislash.GUI elements which let the player view the visualizer, graphs, data about the food products,
...
public class DraftLayout extends GridPane
{
  ...
  Map map;
  //pointer to the main starvationevasion.client.Aegislash.GUI
  GUI gui;
  ...
  /**
   * Simple getter function called by the main gui to let the starvationevasion.client.Aegislash.GUI get the product bar
   ...
   * instead of the main starvationevasion.client.Aegislash.GUI
