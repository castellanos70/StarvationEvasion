...
import Logic.geography.MapUtil;
...
/**
 * DraftStatus is the starvationevasion.client.Aegislash.GUI element responsible for showing the player the current state of the DraftPhase
