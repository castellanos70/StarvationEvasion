...
/**
 * ProductBarElement is the starvationevasion.client.Aegislash.GUI element responsible for representing one of the products on the product bar
...
public class ProductBarElement extends StackPane
{
  ...
  private void initializeLabel()
  {
    ...
    label.setVisible(false);
    label.getStylesheets().add("/starvationevasion/client/Aegislash/GUI/DraftLayout/style.css");
