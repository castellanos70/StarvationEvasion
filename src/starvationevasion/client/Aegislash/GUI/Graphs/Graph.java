package starvationevasion.client.Aegislash.GUI.Graphs;
...
public class Graph
{
  ...
  public Graph()
  {
    ...
    lineChart.getStylesheets().add("/starvationevasion/client/Aegislash/GUI/Graphs/style.css");
  ...
  /**
   * Returns the lineChart to display on the starvationevasion.client.Aegislash.GUI
   * @return
   */
