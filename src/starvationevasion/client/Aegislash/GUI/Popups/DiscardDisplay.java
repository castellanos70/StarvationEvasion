...
/**
 * starvationevasion.client.Aegislash.GUI element which is supposed to display the discard cards in the discard pile
...
public class DiscardDisplay extends BorderPane
{
   ...
   * Takes gui as an argument
   * @param gui gui which owns it
   */
