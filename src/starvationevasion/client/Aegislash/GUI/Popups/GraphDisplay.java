package starvationevasion.client.Aegislash.GUI.Popups;

import starvationevasion.client.Aegislash.GUI.GUI;
import starvationevasion.client.Aegislash.GUI.Graphs.Graph;
...
/**
 * starvationevasion.client.Aegislash.GUI element which displays the graphs during the drafting phase
 */
public class GraphDisplay extends BorderPane
{
  ...
  public GraphDisplay(GUI gui)
  {
    ...
    currentRegion = gui.getAssignedRegion();
