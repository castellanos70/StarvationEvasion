...
/**
 * SummaryBar is the node which is displayed at the top of the starvationevasion.client.Aegislash.GUI. It displays:
 *
 * Game's current year
...
public class SummaryBar extends GridPane
{
  ...
  public SummaryBar(GUI gui)
  {
    ...
    //set assignedRegion to whatever the starvationevasion.client.Aegislash.GUI was passed
