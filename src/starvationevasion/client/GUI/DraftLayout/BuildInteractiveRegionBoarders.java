...
public class BuildInteractiveRegionBoarders
{
            ...
            Color fillColor)
    {
        ...
        sp.getChildren().addAll(middleAmericaMainPath,
                middleAmericaLargeSubPath1, middleAmericaLargeSubPath2,
                middleAmericaSmallSubPath1, middleAmericaSmallSubPath2,
                middleAmericaSmallSubPath3, middleAmericaSmallSubPath4);
            ...
            Color GlowColor, Color fillColor)
    {
        ...
        {
            System.out.println(
                    "Trigger Southern Planes and Delta States Regional Stats");
            ...
            Color fillColor)
    {
        ...
        sp.getChildren().addAll(arcticAmericaMainPath1, arcticAmericaMainPath2,
                arcticAmericaSubPath1, arcticAmericaSubPath2,
                arcticAmericaSubPath3, arcticAmericaSubPath4);
    }
            ...
            Color fillColor)
    {
        ...
        sp.getChildren().addAll(russiaCaucausMainPath, russiaCaucausSubPath1,
                russiaCaucausSubPath2, russiaCaucausSubPath3,
                russiaCaucausSubPath4);
            ...
            Color fillColor)
    {
        ...
        sp.getChildren().addAll(oceaniaMainPath, oceaniaSubPath1,
                oceaniaSubPath2, oceaniaSubPath3, oceaniaSubPath4,
                oceaniaSubPath5, oceaniaSubPath6, oceaniaSubPath7,
                oceaniaSubPath8, oceaniaSubPath9, oceaniaSubPath10,
                oceaniaSubPath11, oceaniaSubPath12, oceaniaSubPath13,
                oceaniaSubPath14, oceaniaSubPath15, oceaniaSubPath16,
                oceaniaSubPath17);
    }
     ...
     * @param color
     * @param mode
     *            Method to change styles of a region e.g the boarder color or
     *            fill color, this method allows to get rid of (some..)
     *            repetitive code. Let Mode = 1 represent setting region paths
     *            stroke Let Mode = 2 represent setting region paths fill
     * 
     */
