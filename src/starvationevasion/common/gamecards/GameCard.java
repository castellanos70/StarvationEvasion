...
/**
 * PolicyCard is the structure used by the Client, Server and
 ...
 * <br>
 *
 * If the client does extend this class, DO NOT send the extended
...
public abstract class GameCard implements Sendable
{
  ...
  // =========================================================================================
  /**
   * Every policy card must have an owner. This is the player
  ...
  // =========================================================================================
  /**
   * Some policy cards require quantity X, Y and/or Z. The units of
   ...
   * <br>
   *
   * Between the time when a PolicyCard is instantiated and
   ...
   * <br>
   *
   * Additionally, at the end of the voting phase, the Server must
