package starvationevasion.communication.ClientTest.Graphs;

import javafx.collections.ObservableList;
import javafx.scene.chart.LineChart;
import javafx.scene.chart.NumberAxis;
import javafx.scene.chart.XYChart;
import starvationevasion.client.GUI.Graphs.*;
import starvationevasion.client.GUI.Graphs.HoveredNode;
...
public class GraphProductsDollars extends Graph
{
  ...
  public void addDataPoint(int year, int[] grossIncome, int[] foodProduced, int[] foodConsumed)
  {
    for (int i = 0; i < 12; ++i)
    {
      ...
      data.setNode(new starvationevasion.client.GUI.Graphs.HoveredNode(grossIncome[i]));
    ...
    for (int i = 0; i < 12; ++i)
    {
      ...
      data.setNode(new starvationevasion.client.GUI.Graphs.HoveredNode(foodProduced[i]));
