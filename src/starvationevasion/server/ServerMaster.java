...
public class ServerMaster
{
  ...
  private LinkedList<ClientWorker> allConnections = new LinkedList<>();
  ...
  {
    for (ClientWorker workers : allConnections)
    {
  ...
  public boolean addUser (User u, ClientWorker client)
  {
  ...
  private void websocketConnect(ClientWorker worker) throws IOException
  {
    // Handling websocket
    ...
    while((line = worker.getClientReader().readLine()) != null)
    {
      ...
      if (line.contains("Sec-WebSocket-Key:"))
      {
        ...
        String socketKey = ServerMaster.handshake(key);
