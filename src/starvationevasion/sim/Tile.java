...
public class Tile
{
  ...
  public double getDistance(Tile other)
  {
    ...
    double dist = (otherLon - lon) * (otherLon - lon) +
                  (otherLat - lat) * (otherLat - lat);
  ...
  public ByteBuffer toByteBuffer()
  {
    ...
    buf.putFloat(BYTE_DEF.LONGITUDE.index(), (float) lon);
    buf.putFloat(BYTE_DEF.LATITUDE.index(), (float) lat);
  ...
  /** Get longitude and latitude of the "center" of the tile */
  ...
  public float getMaxAnnualTemp() { return maxAnnualTemp; }

  public void setMaxAnnualTemp(float maxAnnualTemp) { this.maxAnnualTemp = maxAnnualTemp; }

  public float getMinAnnualTemp() { return minAnnualTemp; }

  public void setMinAnnualTemp(float minAnnualTemp) { this.minAnnualTemp = minAnnualTemp; }

  public float getAvgDayTemp() { return avgDayTemp; }

  public void setAvgDayTemp(float avgDayTemp) { this.avgDayTemp = avgDayTemp; }

  public float getAvgNightTemp() { return avgNightTemp; }

  public void setAvgNightTemp(float avgNightTemp) { this.avgNightTemp = avgNightTemp; }

  public float getProj_maxAnnualTemp() { return proj_maxAnnualTemp; }

  public void setProj_maxAnnualTemp(float proj_maxAnnualTemp) { this.proj_maxAnnualTemp = proj_maxAnnualTemp; }

  public float getProj_minAnnualTemp() { return proj_minAnnualTemp; }

  public void setProj_minAnnualTemp(float proj_minAnnualTemp) { this.proj_minAnnualTemp = proj_minAnnualTemp; }

  public float getProj_avgDayTemp() { return proj_avgDayTemp; }

  public void setProj_avgDayTemp(float proj_avgDayTemp) { this.proj_avgDayTemp = proj_avgDayTemp;}

  public float getProj_avgNightTemp() { return proj_avgNightTemp; }

  public void setProj_avgNightTemp(float proj_avgNightTemp) { this.proj_avgNightTemp = proj_avgNightTemp; }

  /** Annual number frost free nights */
  ...
  public void setRainfall(float rainfall) { this.rainfall = Math.max(0, rainfall); }

  public float getProj_rainfall() { return proj_rainfall; }

  public void setProj_rainfall(float proj_rainfall) { this.proj_rainfall = proj_rainfall; }

  /** Crop currently planted/grown in the tile */
  public EnumFood getCurrCrop() { return currCrop; }

  public void setCurrCrop(EnumFood crop) { currCrop = crop; }
