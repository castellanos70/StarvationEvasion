 ...
 * Phase_01
 *
 * class is used to convert between the worldfoodgame.model and the GUI
...
public abstract class MapConverter
{
   ...
   * worldfoodgame.gui space and map.modle space.
   */
   ...
   * @return double y, in worldfoodgame.gui/Cartesian space.
   */
   ...
   * @return double x, in worldfoodgame.gui/Cartesian space.
   */
